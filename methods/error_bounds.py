...
"""
This calculates the derivative (up to third) of the residual r of the Lagrange polynomial.
...
"""
This function should upper bound the reversed condition on/o1 for singular matrices 
